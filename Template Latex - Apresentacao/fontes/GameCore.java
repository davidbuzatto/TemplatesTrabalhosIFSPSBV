...
public abstract class GameCore {
    ...
    // indica se o jogo está sendo executado
     ...
     * Como a máquina virtual deve finalizar apenas quando o daemon 
     * estiver rodando, isso dá certeza que System.exit(0) é chamado 
     * somente quanto necessário. Isso se faz necessário para quando 
     * o sistema de som do Java estiver sendo executado.
     */
    public void lazilyExit() {
        Thread thread = new Thread() {
            public void run() {
                // primeiro aguarda que a máquina virtual finaliza 
                // por si própria
                try {
                    Thread.sleep( 2000 );
                } catch ( InterruptedException ex ) { }
                // o sistema ainda está rodando, então força a 
                // finalização
                System.exit( 0 );
            }
        };
    ...
    /**
     * Atualiza o estado do jogo/animação baseado da quantidade 
     * de tempo que passou entre a iteração atual e a anterior.
     */
